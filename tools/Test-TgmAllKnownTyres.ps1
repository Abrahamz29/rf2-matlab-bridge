[CmdletBinding()]
param(
    [string]$TgmRoot = "tools/cache/tyres/tgm",
...
try {
    ...
    $batch = "addpath('matlab'); report = rf2TgmAllKnownTyresSmoke('TgmRoot','$tgmRootEscaped','ReportPath','$reportPathEscaped','RoundtripDir','$roundtripDirEscaped'); assert(report.passed);"
