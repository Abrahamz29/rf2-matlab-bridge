...
try {
    ...
    $batch = "addpath('bridge/matlab'); addpath('tyres/matlab'); addpath('tracks/blacklake/matlab'); report = rf2TgmAllKnownTyresSmoke('TgmRoot','$tgmRootEscaped','ReportPath','$reportPathEscaped','RoundtripDir','$roundtripDirEscaped'); assert(report.passed);"
