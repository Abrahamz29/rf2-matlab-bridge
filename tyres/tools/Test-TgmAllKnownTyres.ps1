...
try {
    ...
    $batch = "addpath('tyres/matlab/functions'); report = rf2TgmAllKnownTyresSmoke('TgmRoot','$tgmRootEscaped','ReportPath','$reportPathEscaped','RoundtripDir','$roundtripDirEscaped'); assert(report.passed);"
