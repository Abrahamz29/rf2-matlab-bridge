function report = rf2TgmGenChartReport(options)
...
if status ~= 0
    error("rf2TgmGenChartReport:CommandFailed", "Chart report failed:\n%s", output);
end
...
error("rf2TgmGenChartReport:PythonNotFound", "Could not find a Python executable.");
end
