function report = rf2ExtractTgmGenOds(options)
...
if status ~= 0
    error("rf2ExtractTgmGenOds:CommandFailed", "ODS extraction failed:\n%s", output);
end
...
error("rf2ExtractTgmGenOds:PythonNotFound", "Could not find a Python executable.");
end
