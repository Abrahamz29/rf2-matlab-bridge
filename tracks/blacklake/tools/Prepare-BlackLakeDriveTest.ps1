...
function Install-JoesvilleAiwFallback {
    ...
    $aiwPatcher = Join-Path $ProjectRoot "tracks\blacklake\tools\patch_blacklake_drive_aiw.py"
...
This folder was generated by tracks\blacklake\tools\Prepare-BlackLakeDriveTest.ps1.
...
$builder = Join-Path $ProjectRoot "tracks\blacklake\tools\blacklake_builder.py"
$exportScript = Join-Path $ProjectRoot "tracks\blacklake\tools\Export-BlackLakeGmt.ps1"
$installModDevScript = Join-Path $ProjectRoot "tracks\blacklake\tools\Install-BlackLakeModDev.ps1"
$testModDevScript = Join-Path $ProjectRoot "tracks\blacklake\tools\Test-BlackLakeModDevInstall.ps1"
$packageScript = Join-Path $ProjectRoot "tracks\blacklake\tools\Prepare-BlackLakePackage.ps1"
$rfcmpScript = Join-Path $ProjectRoot "tracks\blacklake\tools\Build-BlackLakeRfcmp.ps1"
$practiceConfigScript = Join-Path $ProjectRoot "bridge\tools\Set-RF2PracticeOnly.ps1"
$viewerScript = Join-Path $ProjectRoot "tracks\blacklake\tools\Start-BlackLakeModDev.ps1"
...
if ($OpenGame) {
    ...
    $steamConfirmScript = Join-Path $ProjectRoot "bridge\tools\Confirm-SteamLaunchDialog.ps1"
