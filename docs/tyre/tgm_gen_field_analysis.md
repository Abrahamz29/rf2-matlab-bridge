...
```powershell
& "C:\Users\Victor\.platformio\penv\Scripts\python.exe" .\tyres\tools\analyze_tgm_gen_fields.py --json
```
...
```powershell
& "C:\Users\Victor\.platformio\penv\Scripts\python.exe" .\tyres\tools\analyze_tgm_gen_fields.py --target tgm-tbc --json
```
