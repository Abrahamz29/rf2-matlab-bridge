...
```matlab
sweep = readtable("tyres/scenarios/slip_angle_5000N_minus12_to_12deg.csv");
```
...
```matlab
fig = rf2PlotTyreBenchSweep("tyres/scenarios/slip_angle_5000N_minus12_to_12deg_results_template.csv");
```
